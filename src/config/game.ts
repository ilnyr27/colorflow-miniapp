...
// Демо-режим для быстрого тестирования (1 день = 0.01 секунды)
export const DEMO_MODE = true; // Переключатель демо-режима
export const DEMO_TIME_MULTIPLIER = 0.01 / (24 * 60 * 60); // 1 день = 0.01 сек
...
// Звучные названия достижений
export const ACHIEVEMENT_TITLES = {
  ascendant: "🎭 Граф Серого",
  unique: "🌈 Мастер Основ", 
  ulterior: "⚫⚪ Повелитель Контрастов",
  ultimate: "👑 Мастер Спектра"
};

// Описания достижений
export const ACHIEVEMENT_DESCRIPTIONS = {
  ascendant: "Получен первый цвет Ascendant - 254 оттенка серого в вашей власти",
  unique: "Получен первый уникальный цвет - RGB/CMY основы покорены",
  ulterior: "Получен первый Ulterior цвет - черное и белое под контролем",
  ultimate: "Достигнут Ultimate уровень - абсолютное мастерство цвета"
};
